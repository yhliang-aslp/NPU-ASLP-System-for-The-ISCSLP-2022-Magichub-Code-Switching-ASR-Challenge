...
from espnet.nets.beam_search_sot import BeamSearch
from espnet.nets.beam_search_sot import Hypothesis
...
class BatchBeamSearch(BeamSearch):
    ...
    def init_hyp(self, x: torch.Tensor, uttnum: torch.Tensor) -> BatchHypothesis:
