...
from wenet.intern_lm.intern_lm_dataset import TextDataset, CollateFunc
from wenet.intern_lm.executor import Executor
from wenet.utils.scheduler import WarmupLR
from wenet.utils.checkpoint import load_ltm_checkpoint, save_checkpoint
...
if __name__ == '__main__':
    ...
    if args.checkpoint is not None:
        infos = load_ltm_checkpoint(model, args.checkpoint)
        infos = {}
    else:
        infos = {}
