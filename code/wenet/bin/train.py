...
from wenet.utils.checkpoint import (load_checkpoint, save_checkpoint, load_biencoder_checkpoint, load_shared_encoder_checkpoint,
                                    load_trained_modules,load_ltm_checkpoint)
...
def main():
    ...
    if args.checkpoint == "biencoder":
        infos = load_biencoder_checkpoint(model, args.checkpoint)
        infos = {}
    elif args.checkpoint == "shared_encoder":
        infos = load_shared_encoder_checkpoint(model, args.checkpoint)
        infos = {}
    elif args.checkpoint is not None:
        infos = load_checkpoint(model, args.checkpoint)
        #for pram in model.encoder.encoders_cn.parameters():
        #   pram.requires_grad = False
        #for pram in model.encoder.encoders_en.parameters():
        #    pram.requires_grad = False
