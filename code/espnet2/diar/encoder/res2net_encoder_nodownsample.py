...
class StandardRes2NetSpeakerVerificationNodownsample(nn.Module):
    """
    ...
    def __init__(self,
                 ...
                 se_channels=128,
                 hidden_dim=256):
        super(StandardRes2NetSpeakerVerificationNodownsample, self).__init__()
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(1, num_filters[0], kernel_size=3, stride=(1, 2),padding=(1, 0)),
            nn.BatchNorm2d(num_filters[0]),
            nn.ReLU(inplace=True)
        )
        self.block1 = self._make_layer(num_filters[0], num_filters[0], layers[0], stride=1)
        self.conv2 = nn.Sequential(
            nn.Conv2d(num_filters[0], num_filters[1], kernel_size=3, stride=(1, 2),padding=(1, 0)),
