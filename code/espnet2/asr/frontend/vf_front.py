...
from espnet.nets.pytorch_backend.frontends.voice_filter import Frontend
...
class VFFrontend(AbsFrontend):
    ...
    def __init__(
        ...
        if frontend_conf is not None:
            ...
            #self.frontend.load_state_dict(torch.load("/home/work_nfs5_ssd/yzli/workspace/seperation/exp/best.pt.tar", 
            #    map_location=torch.device('cpu'))['model_state_dict'])
            #self.frontend.load_state_dict(torch.load("/home/work_nfs5_ssd/yzli/workspace/seperation/exp/best.pt.tar")['model_state_dict'])
        else:
            self.frontend = None
        #self.frontend = None
    ...
    def forward(
        ...
        if self.frontend is not None and e is not None:
            ...
            wav, _, mask = self.frontend(input_stft, feats_lens, e, max_norm)
