...
from espnet.nets.pytorch_backend.frontends.frontend_bf import Frontend
...
class BfAttention(AbsFrontend):
    ...
    def forward(
        self, input: torch.Tensor, input_lengths: torch.Tensor, direction_mask: torch.Tensor
